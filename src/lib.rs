...
#[derive(Debug)]
pub struct TronGridProcessor {
    verbose: bool,
    processed_count: usize,
}

impl TronGridProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting TronGrid processing");
    
    let mut processor = TronGridProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = TronGridProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = TronGridProcessor::new(false);
